defmodule Fade.Broker.ChannelDataMapper do
  alias Fade.Broker.ChannelTypes.{
  ...
  def map_data(data) do
    ...
    |> Enum.map(fn channel ->
      ChannelInfo.new(
        ...
        uncommitted_acknowledgements: channel["acks_uncommitted"],
        uncommitted_messages: channel["messages_uncommitted"],
        unacknowledged_messages: channel["messages_unacknowledged"],
